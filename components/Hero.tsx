          ...
          <div className="absolute bottom-6 left-6 right-6 max-w-[min(46rem,92vw)] md:bottom-8 md:left-8 z-10">
            ...
            >
              ...
              <p className="mt-3 text-sm/6 text-indigo-100/85 max-w-prose">
                Welcome to my Portfolio! I am a Data Center Engineering Assistant that is seeking to work in Internal IT specializing in system administration from cisco, but additional skills such as knowledge in all things about data centers. Explore my portfolio if you like to!
              </p>
              <Link
href="/about"
